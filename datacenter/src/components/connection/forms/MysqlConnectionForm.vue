  ...
  >
    ...
    <div class="database-connection-form__grid">
      ...
      <el-form-item :label="t('connection.port')" prop="port">
        <el-input v-model.number="formData.port" inputmode="numeric" placeholder="3306" />
      </el-form-item>
    </div>
    ...
    <div class="database-connection-form__grid">
      ...
      <el-form-item :label="t('connection.charset')">
        <el-select v-model="formData.charset" :placeholder="t('connection.charset')" class="w-full">
