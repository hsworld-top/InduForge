      ...
      <div class="space-y-2">
        ...
        <div class="section-block">
          <div class="section-head">
            <span class="section-title">{{ t('connection.connectionManagement') }}</span>
                ...
                <div class="mt-2 space-y-2" @dblclick.stop>
                  ...
                  <div class="space-y-1 pb-2 border-b border-gray-200 dark:border-gray-700">
                    ...
                    >
                      ...
                      <div class="flex items-center space-x-1">
                        <el-tooltip :content="t('connection.refreshQueryList')" placement="top">
                          <button
                    ...
                    <template v-else-if="getConnectionState(connection.id).queriesExpanded">
                      <div
                        v-if="getConnectionState(connection.id).queries.length === 0"
                        class="pl-6 text-xs text-gray-500"
                      >
                  ...
                  <div class="space-y-1 pt-1">
                    ...
                    >
                      ...
                      <div class="flex items-center space-x-1">
                        <el-tooltip :content="t('connection.refreshTableList')" placement="top">
                          <button
                        ...
                        <el-tooltip :content="t('connection.viewTableList')" placement="top">
                          <button
                            class="p-1 hover:bg-green-200 dark:hover:bg-green-700 rounded"
                    ...
                    <template v-else-if="getConnectionState(connection.id).tablesExpanded">
                      <div
                        v-if="getConnectionState(connection.id).tables.length === 0"
                        class="pl-6 text-xs text-gray-500"
                      >
                  ...
                  <div class="space-y-1">
                    ...
                    >
                      ...
                      <div class="flex items-center space-x-1">
                        ...
                        <span
                          v-if="!getConnectionState(connection.id).loadingMqttSubscriptions"
                          class="text-purple-600 dark:text-purple-400"
                        >
                          {{ getConnectionState(connection.id).mqttSubscriptions.length }}
                        </span>
                      </div>
                    </div>
                    <div
                    ...
                    <template
                      v-else-if="getConnectionState(connection.id).mqttSubscriptionsExpanded"
                    >
                      <div
                        v-if="getConnectionState(connection.id).mqttSubscriptions.length === 0"
                        class="pl-6 text-xs text-gray-500"
                      >
                      ...
                      >
                        <li
                          ...
                          @dblclick.stop="handleMqttSubscriptionDblClick(connection, subscription)"
                          @contextmenu.prevent.stop="
                            handleMqttSubscriptionContextMenu($event, connection, subscription)
                          "
                        >
                          <el-tooltip
                            ...
                            :show-after="500"
                          >
                            <span class="truncate flex-1 font-medium">{{ subscription.name }}</span>
                          </el-tooltip>
        ...
        <!-- 空状态 -->
        <div v-if="filteredConnections.length === 0" class="text-center py-8 text-gray-500">
          <div class="text-sm">
            {{ searchText ? t('states.noMatchedConnections') : t('states.noDataConnections') }}
          </div>
...
const loadMqttSubscriptions = async (connectionId) => {
  ...
  try {
    const response = await dataAPI.getMqttSubscriptions(props.projectId, connectionId)
