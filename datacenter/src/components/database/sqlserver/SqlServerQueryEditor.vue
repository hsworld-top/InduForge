  ...
  <div class="sqlserver-query-editor flex flex-col h-full">
    ...
    <div class="mb-2 flex items-center justify-between">
      <div class="flex items-center space-x-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <span>{{ t('queryEditor.parameterHintSqlServer') }}</span>
      </div>
    </div>
    ...
    >
      <div class="flex items-center justify-between mb-2">
        ...
        >
          <component
            ...
            class="mr-1 w-4 h-4"
          />
          {{ localTab.parametersExpanded ? t('actions.collapse') : t('actions.expand') }}
        </el-button>
      </div>
      ...
      <div v-show="localTab.parametersExpanded" class="space-y-2 mt-2">
        ...
        >
          ...
          <el-input
            v-model="param.value"
            :placeholder="t('queryEditor.parameterPlaceholder', { index: param.name })"
            size="small"
            class="flex-1"
          >
            <template #prepend>
    ...
    >
      <div class="flex items-center justify-between mb-2 flex-shrink-0">
        ...
        <el-button size="small" @click="clearResult">{{ t('actions.close') }}</el-button>
      </div>
