...
CREATE TABLE IF NOT EXISTS data_connections (
    ...
    type text NOT NULL CHECK (type IN ('relational', 'mqtt', 'websocket', 'opcua', 'modbus', 'http', 's7')),
    category text NOT NULL DEFAULT 'api' CHECK (category IN ('database', 'message', 'protocol', 'api')),
