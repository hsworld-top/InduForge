...
const buildObjectStoreConfig = () => ({
  ...
  accessKey: pickEnvValue(process.env.IF_OBJECT_STORE_ACCESS_KEY, process.env.SEAWEEDFS_ACCESS_KEY, ""),
  secretKey: pickEnvValue(process.env.IF_OBJECT_STORE_SECRET_KEY, process.env.SEAWEEDFS_SECRET_KEY, ""),
  ...
  region: pickEnvValue(process.env.IF_OBJECT_STORE_REGION, process.env.SEAWEEDFS_REGION, "us-east-1"),
  provider: pickEnvValue(process.env.OBJECT_STORAGE_PROVIDER, process.env.STORAGE_PROVIDER, "induforge-object-store"),
});
