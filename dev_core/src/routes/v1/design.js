 ...
 * Requirements: 7.5
 */
router.delete('/projects/:projectId/pages/:pageId', designController.deletePage)
 ...
 * Body: { name: string }
 */
router.patch('/projects/:projectId/pages/:pageId/rename', designController.renamePage)
 ...
 */
router.patch('/projects/:projectId/pages/:pageId/move', designController.movePage)
...
router.get('/projects/:projectId/settings', designController.getProjectSettings)
router.put('/projects/:projectId/settings', designController.updateProjectSettings)
