...
async function updateEntryConfig(req, res, next) {
  try {
    ...
    const result = await designService.updateEntryConfig(projectId, entryConfig)
...
async function updateProjectSettings(req, res, next) {
  try {
    ...
    const result = await designService.updateProjectSettings(projectId, settings, req.user.id)
