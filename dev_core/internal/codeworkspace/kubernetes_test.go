...
func TestKubernetesCreateUsesRestrictedPermissionInitializer(t *testing.T) {
	...
	spec := ContainerSpec{
		...
		Mounts: []Mount{
			...
			{Target: "/workspace/.workspace/context", Subpath: "project-1/context-state", ReadOnly: true},
	...
	for _, expected := range []string{
		...
		`"mountPath":"/project/workspace/.workspace/context","name":"workspaces","readOnly":true,"subPath":"project-1/context-state"`,
		`chown 1000:1000 /project/workspace/.workspace`,
