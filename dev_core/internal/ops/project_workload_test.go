...
func TestRenderProjectWorkloadManifestSeparatesRolesAndHostPort(t *testing.T) {
	...
	for _, expected := range []string{"if-env-666666666666", "if-project-999999999999-base", "hostPort: 17800", "induforge.io/host-node-id", "maxUnavailable: 1, maxSurge: 0", "allowPrivilegeEscalation: false", "IF_RELEASE_ROOT", "IF_WORK_ROOT", `IF_PROJECT_ID, value: "` + testProjectID + `"`, "mountPath: /opt/induforge/release", "kind: Service", "image: induforge/project-gateway:1.0.0", "image: induforge/project-runtime-api:1.0.0", `"--project-id", "` + testProjectID + `"`, "httpGet: {host: 127.0.0.1, path: /health, port: 18081}", "name: runtime-provision-nats", "name: runtime-provision-state", "name: runtime-api-artifact-prepare", "name: runtime-api-secrets", "runtime-api-tokens.json", "imagePullPolicy: IfNotPresent", `path: "/var/lib/induforge/node-agent/deployments/99999999-9999-4999-8999-999999999999/release/releases/sha256-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"`} {
