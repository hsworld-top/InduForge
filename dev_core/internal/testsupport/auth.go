...
func NewAuth(t *testing.T, role string) (*auth.Service, string, auth.User) {
	...
	user := auth.User{ID: UserID, TenantID: TenantID, Username: "tester", PasswordHash: hash, Role: role, Status: "active", TenantCode: "default", TenantName: "默认租户", TenantStatus: "active"}
...
func (r *authRepository) UpdatePassword(context.Context, string, string) error { return nil }
