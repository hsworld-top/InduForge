...
<reference>
@/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/references/user-profiling.md` to load:
