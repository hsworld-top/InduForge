...
<required_reading>
@/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /mnt/d/SVNCode/indu-forge/.claude
                  → checks /mnt/d/SVNCode/indu-forge/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /mnt/d/SVNCode/indu-forge/.claude/get-shit-done
                  → writes to /mnt/d/SVNCode/indu-forge/.claude/get-shit-done/hooks/
...
@/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
