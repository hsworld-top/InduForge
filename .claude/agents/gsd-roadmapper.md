...
Reference full template: `/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/templates/state.md`.
