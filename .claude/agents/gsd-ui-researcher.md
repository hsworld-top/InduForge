...
Use template from `/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
