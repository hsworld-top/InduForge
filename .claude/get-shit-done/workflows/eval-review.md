...
```bash
AUDITOR_MODEL=$(node "/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /mnt/d/SVNCode/indu-forge/.claude/agents/gsd-eval-auditor.md for instructions.
