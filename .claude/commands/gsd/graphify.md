...
Knowledge graph is disabled. To activate:
  ...
  node /mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
