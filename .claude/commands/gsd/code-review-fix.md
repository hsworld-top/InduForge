...
<execution_context>
@/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
