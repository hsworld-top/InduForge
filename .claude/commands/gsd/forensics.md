...
<execution_context>
@/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
