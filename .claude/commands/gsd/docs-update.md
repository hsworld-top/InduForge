...
<execution_context>
@/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/mnt/d/SVNCode/indu-forge/.claude/get-shit-done/workflows/docs-update.md end-to-end.
