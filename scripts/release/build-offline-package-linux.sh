...
build_business_images() {
  ...
  docker build \
    -t induforge/designer-code-server:4.131.0-node24.19.0-pnpm11.21.0-8147b161-arm64 \
    -f "$REPO_ROOT/designer/code-workspace/Dockerfile" \
    "$REPO_ROOT"
  "$REPO_ROOT/designer/code-workspace/verify-image.sh" induforge/designer-code-server:4.131.0-node24.19.0-pnpm11.21.0-8147b161-arm64
