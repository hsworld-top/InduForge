...
import { useInduForgeHostContext } from "@/hooks/useInduForgeHostContext";
...
export function AppShell() {
  ...
  const { locale, setLocaleFromHost, t: translate } = useI18n();
  useInduForgeHostContext(setLocaleFromHost);
  ...
  const windowTitle = activeCwdName ? `${activeCwdName} - AI 开发` : "InduForge AI";
