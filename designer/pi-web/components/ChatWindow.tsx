      ...
      {isEmptyNew ? (
        <div className="flex flex-1 flex-col items-center justify-center overflow-y-auto px-4 py-8">
          <div className="w-full max-w-[820px]">
            ...
            >
              <h1 style={{ margin: 0, color: "var(--text)", fontSize: isMobile ? 20 : 22, fontWeight: 650, lineHeight: 1.35, letterSpacing: 0 }}>
                开始开发
              </h1>
              <div style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--text-muted)", fontSize: 12, lineHeight: 1.4 }}>
                <span>当前工程</span>
                <span aria-hidden="true" style={{ width: 3, height: 3, borderRadius: "50%", background: "var(--border)", flexShrink: 0 }} />
                <code style={{ color: "var(--text)", fontFamily: "var(--font-mono)", fontSize: 12 }}>/workspace</code>
              </div>
            </div>
