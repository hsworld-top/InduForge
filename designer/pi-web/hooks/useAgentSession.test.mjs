...
test("does not expose system prompt loading or viewing controls", () => {
  assert.doesNotMatch(source, /loadSystemPrompt|onSystemPromptLoaderChange|setSystemPrompt/);
  assert.doesNotMatch(appShellSource, /handleSystemPromptToggle|systemPromptLoaderRef|onSystemPromptChange/);
});
