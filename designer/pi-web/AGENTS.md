...
```bash
pnpm dev:pi-web   # port 30141
```

Typecheck: `pnpm typecheck:pi-web`
Lint: `pnpm lint:pi-web`
**Never run `next build` during dev** — pollutes `.next/` and breaks `pnpm dev:pi-web`.
