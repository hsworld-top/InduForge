 ...
 */
const enumPropSchemaArb = fc.record({
 ...
 */
const propSchemaArb = fc.oneof(
  booleanPropSchemaArb,
  numberPropSchemaArb,
  stringPropSchemaArb,
  enumPropSchemaArb
)
 ...
 */
const propKeyArb = fc.string({ minLength: 1, maxLength: 20 })
    ...
    fc.assert(
      fc.property(
        ...
        (propKey, propSchema) => {
          ...
          const propsValue = propSchema.default !== undefined 
            ? { [propKey]: propSchema.default }
            : {}
