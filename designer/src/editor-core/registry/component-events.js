...
export const defaultEventDefinitions = [
...
/** @type {Record<string, Array<string | EventDefinition>>} */
 ...
 * @returns {EventDefinition[]} 事件定义列表
 */
export function getComponentEventDefinitions(type) {
...
/**
 * 规范化事件定义，兼容字符串数组
 * @param {Array<string | EventDefinition>} events - 事件定义列表
 * @returns {EventDefinition[]} 标准事件定义
 */
export function normalizeEventDefinitions(events) {
