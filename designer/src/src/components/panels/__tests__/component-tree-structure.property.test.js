...
function containerComponentArb(maxDepth) {
    ...
    return fc.record({
        ...
        props: fc.constant({}),
        children: fc.array(fc.oneof(leafComponentArb, containerComponentArb(maxDepth - 1)), { minLength: 0, maxLength: 3 }),
    });
}
 ...
 */
const componentArb = fc.oneof(leafComponentArb, containerComponentArb(2));
...
describe('Property 8: Component Tree Structure', () => {
    ...
    it('should display all components from the schema in the tree', () => {
        fc.assert(
            fc.property(componentsArrayArb, (components) => {
    ...
    it('should display children as nested items under their parent', () => {
        fc.assert(
            fc.property(containerComponentArb(2), (containerComponent) => {
