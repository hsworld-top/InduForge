...
function normalizeProjectList(payload: DebugProjectListPayload | null | undefined): DebugProjectSummary[] {
...
export const debugProjectApi = {
  async resolveDefaultProjectByName(projectName = DEFAULT_DEBUG_PROJECT_NAME): Promise<DebugProjectSummary | null> {
