...
export function useDragDrop(options = {}) {
    const { gridSize = 10, snapEnabled = true, minWidth = MIN_WIDTH, minHeight = MIN_HEIGHT } = options;
    ...
    function getDragResult(applySnap = snapEnabled) {
        const newPosition = calculateDragPosition({ left: dragStart.componentLeft, top: dragStart.componentTop }, dragDelta);
