 ...
 *
 * @module stores/editor/node-update-layout-patches
 */
 ...
 * @param {Record<string, any> | undefined} layoutProps
 * @returns {number}
 */
export function resolveElLayoutMinHeight(layoutProps) {
...
/**
 * @param {import('@/editor-core').ComponentNode | null} node
 * @param {Partial<import('@/editor-core').ComponentNode>} patch
 * @returns {Partial<import('@/editor-core').ComponentNode>}
 */
export function syncAbsoluteSizePatch(node, patch) {
 ...
 * @returns {Partial<import('@/editor-core').ComponentNode>}
 */
export function syncElLayoutMinHeightPatch(node, patch, nextProps) {
...
/**
 * @param {import('@/editor-core').DocumentModel | null | undefined} doc
 * @param {import('@/editor-core').ComponentNode | null} node
 * @param {Partial<import('@/editor-core').ComponentNode>} patch
 * @returns {Partial<import('@/editor-core').ComponentNode>}
 */
export function clampElContainerSizePatch(doc, node, patch) {
 ...
 * @returns {Partial<import('@/editor-core').ComponentNode>}
 */
export function clampElColSpanPatch(doc, node, patch) {
 ...
 * @returns {Partial<import('@/editor-core').ComponentNode>}
 */
export function clampElColOffsetPatch(doc, node, patch) {
  if (!node || node.type !== "ElCol" || !patch?.props) return patch;
 ...
 * @returns {Partial<import('@/editor-core').ComponentNode>}
 */
export function clampElColShiftPatch(doc, node, patch) {
  if (!node || node.type !== "ElCol" || !patch?.props) return patch;
 ...
 * @returns {Partial<import('@/editor-core').ComponentNode>}
 */
export function clampElLayoutRowColumnsPatch(node, patch) {
