...
import { unwrapApiData, type PagesListPayload } from "@/types/api";
import { projectApi } from "@/services";

export async function fetchProjectVariablesAndSettings(
  projectId: string,
): Promise<{
  varsResult: unknown;
...
export async function fetchPagesListPayload(
  projectId: string,
): Promise<PagesListPayload> {
