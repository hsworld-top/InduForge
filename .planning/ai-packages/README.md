...
## 3. 推荐使用顺序
1. 先看 [产品定义](../../docs/产品定义.md)。
2. 再看本模块 AI 分发包。
3. 再看 `./tasks/` 下对应模块任务文档。
4. 如涉及跨模块契约，再看 `../../docs/contracts/`。
5. 如涉及平台当前主线，再看 [开发态预览专项计划](../docs/process/platform/开发态预览专项计划.md) 和 [运行时闭环专项计划](../docs/process/platform/运行时闭环专项计划.md)。
