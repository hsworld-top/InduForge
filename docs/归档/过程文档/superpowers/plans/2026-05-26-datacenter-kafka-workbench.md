...
export type { KafkaField, KafkaPreview, KafkaPreviewSample, KafkaTopicGroup, KafkaTopicMapping }
...
const securityProtocol = computed(() =>
  String(props.connection.config?.securityProtocol || 'PLAINTEXT'),
)
</script>
```
