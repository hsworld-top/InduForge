...
- 本文档聚焦组件开发规则，不替代 [设计器概览](./README.md)、[尺寸约定](./size-convention.md) 和 [Designer 发布态 Schema 契约](../../04-契约与规范/跨模块契约/designer-publish-schema.md)。
...
- 是否确认发布态字段仍符合 [Designer 发布态 Schema 契约](../../04-契约与规范/跨模块契约/designer-publish-schema.md)。
...
- [设计器概览](./README.md)
- [Designer 发布态 Schema 契约](../../04-契约与规范/跨模块契约/designer-publish-schema.md)
