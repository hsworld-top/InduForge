...
| 生产采集 | [节点打包](../../scripts/release/build-node-agent-packages.sh) 交付唯一的 [.NET Runtime](../../collector/README.md)，由 NodeAgent 托管原生进程 | 正式驱动限于 Modbus TCP、OPC UA；协议配置、生产模式与目标操作系统分别验收，开发驱动注册不代表生产支持                                                                                                                 |
