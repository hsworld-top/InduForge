...
- 开发过程文档、专项计划、分析稿、审计稿、测试清单、AI 辅助资料统一放在 `.planning/`。
...
## 3. 过程文档入口
- [过程文档索引](../.planning/docs/process/README.md)
- [AI 辅助资料索引](../.planning/ai-packages/README.md)

## 4. 文档维护规则
- 未确认的规划、专项计划、分析稿、审计稿、测试清单不要放在 `docs/`。
- 这类资料统一迁移到 `.planning/docs/process/` 或 `.planning/ai-packages/`。
