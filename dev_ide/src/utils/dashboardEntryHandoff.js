 ...
 */
export const buildDashboardRedirectLocation = (to = {}) => ({
  path: '/dashboard',
  query: { ...(to?.query || {}) },
})
 ...
 */
export const extractDashboardHandoffId = (query = {}) => normalizeQueryValue(query?.handoffId)
 ...
 */
export const stripDashboardHandoffQuery = (query = {}) => {
 ...
 */
export const createRestoredEmbeddedTab = (payload = {}) => {
