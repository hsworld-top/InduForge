<template>
  <div class="h-full flex flex-col p-4 md:p-6 max-w-[1600px] mx-auto w-full font-sans antialiased">
    <!-- 页头 -->
    <div
      class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5 md:mb-6 lg:mb-8"
    >
      <div>
        <h1
        ...
        <p class="text-xs md:text-sm font-medium text-slate-500 dark:text-slate-400 mt-1 md:mt-2">
          {{ t('tenantManagement.list') }} · {{ t('tenantManagement.companyInfo') }} ·
      ...
      >
        <svg
          class="w-4 h-4 md:w-5 md:h-5 transition-transform group-hover:scale-110"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          stroke-width="2"
    ...
    <!-- 工具栏和表格卡片 -->
    <div
      class="flex-1 flex flex-col bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden min-h-0"
    >
      <!-- 工具栏 -->
      <div
        class="flex flex-col sm:flex-row gap-4 p-5 border-b border-slate-200/60 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-900/50"
      >
      ...
      <div class="flex-1 overflow-auto custom-scrollbar">
        <table class="w-full text-sm text-left text-slate-600 dark:text-slate-400">
          <thead
            class="text-xs text-slate-500 uppercase bg-slate-50/90 dark:bg-slate-900/90 dark:text-slate-400 sticky top-0 z-10 backdrop-blur-md border-b border-slate-200 dark:border-slate-800"
          >
            <tr>
          ...
          >
            ...
            <tr v-else-if="!tenants.length">
              <td colspan="5" class="px-6 py-20 text-center text-slate-500 dark:text-slate-400">
                <div class="flex flex-col items-center justify-center">
                  <svg
                    class="w-16 h-16 mb-4 text-slate-300 dark:text-slate-600"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            >
              ...
              <td
                class="px-6 py-4 font-medium text-slate-500 dark:text-slate-400 whitespace-nowrap"
              >
      ...
      <!-- 分页 -->
      <div
        class="flex items-center justify-between p-4 border-t border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900"
      ...
      >
        ...
        <div class="flex items-center gap-2">
          ...
          <span
            class="text-sm font-bold text-slate-700 dark:text-slate-300 min-w-[3rem] text-center"
          >
